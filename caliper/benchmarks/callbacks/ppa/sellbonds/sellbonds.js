...
module.exports.info = "Sell bond callback";
...
module.exports.init = async (blockchain, context, args) => {
  ...
  // minterIdentity = Array.from(ctx.networkInfo.getClientsOfOrganization(args.minterOrg));
...
module.exports.run = async () => {
  let txArgs = {
    chaincodeFunction: "WantToSell",
    chaincodeArguments: [50,9900.02,"5c71543d247ae2789eadb42b94369af275497fa6d462acb108a78e366b765ad4.0"],
