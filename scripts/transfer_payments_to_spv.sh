...
peer chaincode invoke -o $ORDERER_ADDRESS --tls true --cafile $ORDERER_CA -C $CHANNEL_NAME -n $CC_NAME -c '{ "Args": ["TransferPaymentsToSpv","[\"1225615e6d2b416a86e0156a64c82f7604d9ad4645908042492a3243a9f31df5:0\"]","eDUwOTo6Q049c3B2LWNsaWVudCxPVT1jbGllbnQrT1U9c3B2K09VPWNsaWVudGUsTz1TUFYsTD1TUFZMb2NhdGlvbixTVD1TUFZTdGF0ZSxDPVNQOjpDTj1yb290Y2Etc3B2LE9VPUh5cGVybGVkZ2VyIEZhYnJpYyxPPVNQVixMPVNQVkwsU1Q9U1BWU1QsQz1TUA=="] }' --peerAddresses $CORE_PEER_ADDRESS --peerAddresses localhost:11051 --peerAddresses localhost:8051 --tlsRootCertFiles $CORE_PEER_TLS_ROOTCERT_FILE --tlsRootCertFiles  $(cd .. && echo $PWD/fabric-ca/investor/peers/investor-peer-1/tls/ca.crt) --tlsRootCertFiles  $(cd .. && echo $PWD/fabric-ca/farmer/peers/farmer-peer/tls/ca.crt)
